    ...
    public partial class Form104 : Form
    {
        ...
        private void Form104_Load(object sender, EventArgs e)
        {
            ...
            if (q1 == 1)
            {
                ...
                button5.Text = "Кой цвят не фигурира в българското знаме?";
                button1.Text = "Бяло"; 
                button2.Text = "Зелено";
                button3.Text = "Червено";
                button4.Text = "Черно"; // Верният отговор
            }
            if (q1 == 2)
            {
                button5.Text = "Пайсии Хилендарски е написал?";
                button1.Text = "“История славянобългарска“"; // Верният Отговор
                button2.Text = "Програма";
                button3.Text = "Фейлетон";
                button4.Text = "“Ромео и Жулиета“";
            }
            if (q1 == 3)
            {

                button5.Text = "Априлското възстание избухва през кой месец?";
                button1.Text = "Декември";
                button2.Text = "Май";
                button3.Text = "Април"; // Верният отговор
                button4.Text = "Март";
            }
        }
        ...
        {
            if (button5.Text == "Кой цвят не фигурира в българското знаме?")
            {
                player.Play();
            ...
            if (button5.Text == "Пайсии Хилендарски е написал?")
            {
            ...
            if (button5.Text == "Априлското възстание избухва през кой месец?")
            {
                player.Play();
